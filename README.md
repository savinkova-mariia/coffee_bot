...
Мой проект заключается в Telegram бот для заказа кофе, а также информационное табло для бариста, которое в реальном времени анонсирует поступление заказов.
## Описание
